...
def main():
    ...
    for scene_id, paths in scenes:
        ...
        if single_model:
            ...
            with show.paths(paths, output_file=gt_filename, colors=colors, pred_length=len(predicted_paths[0])):
                pass
            ...
            with show.paths(full_predicted_paths, output_file=pred_filename, colors=colors, pred_length=len(predicted_paths[0])):
                pass
